...
function DetalleMascota() {
    ...
    // Estilo reutilizable para filas de datos
    const filaStyle = {
        display: "flex",
        gap: 8,
        marginBottom: 8,
    ...
    return (
        <div className="detalle-mascota-container" style={{ display: "flex", gap: 20, padding: 20, flexWrap: "wrap" }}>
            ...
            <div className="detalle-mascota-info" style={{ flex: 1, minWidth: 320 }}>
                ...
                {/* Raza */}
                <div style={filaStyle}>
                    <span style={labelStyle}>Raza:</span>
                ...
                <div style={filaStyle}>
                    ...
                    <span>{new Date(mascota.createdAt).toLocaleDateString()}</span>
                </div>

                {/* Publicado por */}
                <div style={filaStyle}>
                    <span style={labelStyle}>Publicado por:</span>
                    <span>{mascota.usuario?.nombre || 'Usuario desconocido'}</span>
                </div>

                {/* Mapa */}
                <div style={{ marginTop: 16 }}>
                    <h3 style={{ fontWeight: "bold", marginBottom: 4 }}>Ubicación</h3>
                    {hasLocation ? (
                        <>
                            {!isOwner && (
